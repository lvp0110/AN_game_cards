...
<p>Беспокоит караоке клуб, расположенный на 1 этаже</p>
...
<div class="roof_box_1"></div>
 ...
 let btn = document.getElementById('butt_choose');
 let btn1 = document.getElementById('butt_noise');
 let p = document.getElementById('p1');

 let block = document.getElementById('ba');
 let rel = document.getElementById('rel');
 let retAp = localStorage.setItem('string',rel);

 let mainPage = document.getElementById('main_page');

 let canvOpen = document.getElementById('canv');

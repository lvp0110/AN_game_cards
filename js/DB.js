...
// const Images = document.querySelectorAll('.img_constr');

// const [leftWall, topWall, rightWall, bottomWall] = document.querySelectorAll('#leftWall, #topWall, #rightWall, #bottomWall');
...
function imagesChange (){
    ...
    switch(this.id){
        case 'frame1':
            // imagePath = ImageCollection.find(el=>el.id == this.value);
            leftWall.setAttribute('src', imagePath.imgV);    
            // leftWall.setAttribute('style', 'width: 100px; height: 200px')
            // leftWall.style. = '100px';
            // leftWall.style.height = imagePath.h + 'px';
